...
val toggleFeatureFlagsPatch = bytecodePatch(
    ...
    val flagsToEnable by stringsOption(
        key = "flagsToEnable",
        default = listOf("enable_number_row", "enable_settings_search", "enable_extended_clipboard_history", "require_device_idle_for_content_cache_download", "disable_refresh_in_result_page_emoji_kitchen_browse_search", "more_pill_keys", "undo_access_point"),
